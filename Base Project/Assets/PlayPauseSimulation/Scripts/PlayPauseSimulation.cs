...
public class PlayPauseSimulation : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        jc = new AndroidJavaClass("broadcastplugin.veative.com.masterappbroadcast.DPlay");
        jc.CallStatic("createInstance", this.name); 

        jc = new AndroidJavaClass("broadcastplugin.veative.com.masterappbroadcast.DPause");
        jc.CallStatic("createInstance", this.name); 

        jc = new AndroidJavaClass("broadcastplugin.veative.com.masterappbroadcast.DStop");
        jc.CallStatic("createInstance", this.name);
